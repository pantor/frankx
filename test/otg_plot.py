...
if __name__ == '__main__':
    inp = InputParameter()
    inp.current_position = [-0.160382, -0.53]
    inp.current_velocity = [-0.615, 0.558]
    inp.current_acceleration = [-0.5706, 0.887]
    inp.target_position = [-0.443, -0.3102]
    inp.target_velocity = [0.0] * inp.degrees_of_freedom
    inp.target_acceleration = [0.0] * inp.degrees_of_freedom
    inp.max_velocity = [3.323, 0.171]
    inp.max_acceleration = [4.301, 6.481]
    inp.max_jerk = [5.598, 0.370]
    inp.minimum_duration = None

    print_input_for_mathematica(inp, 0, tf=22.761)
